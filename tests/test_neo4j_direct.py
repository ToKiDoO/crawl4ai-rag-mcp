...
async def test_neo4j_connection():
    ...
    try:
        ...
        async with driver.session() as session:
            ...
            # Clean up
            await session.run("MATCH (t:TestNode {name: $name}) DELETE t", name="connection_test")
...
async def test_knowledge_graph_tools():
    ...
    try:
        ...
        try:
            from knowledge_graph_tools import execute_cypher_query, validate_cypher_query
