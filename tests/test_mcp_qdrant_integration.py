...
class TestMCPQdrantIntegration:
    ...
    async def mock_dependencies(self):
        ...
        with (
            patch("crawl4ai_mcp.AsyncWebCrawler") as mock_crawler_class,
            patch("utils.create_embeddings_batch") as mock_embeddings,
    ...
    async def test_error_handling(self, setup_environment):
        ...
        ctx = create_test_context(crawler=mock_crawler, database_client=mock_db)
