...
from src.utils import add_documents_to_database, search_documents
...
class TestQdrantDatabaseIntegration:
    ...
    async def test_add_documents_with_qdrant(self):
        ...
        # Mock dependencies
        with (
            patch("src.database.qdrant_adapter.QdrantClient") as mock_client,
            ...
            test_docs = {
                ...
                "url_to_full_document": {
                    "http://example.com/test": "Full document content",
                },
            }
