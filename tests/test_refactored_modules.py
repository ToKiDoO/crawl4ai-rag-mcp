...
class TestUtilsModule:
    ...
    def test_url_helpers(self):
        ...
        from utils.url_helpers import normalize_url, is_sitemap, is_txt
...
class TestServicesModule:
    ...
    async def test_crawling_service_import(self):
        ...
        from services.crawling import crawl_batch, crawl_markdown_file, crawl_recursive_internal_links
