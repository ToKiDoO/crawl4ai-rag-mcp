...
def test_path_mapping():
    ...
    test_cases = [
        ("analysis_scripts/test_scripts/test_hallucination.py", "Path mapping for test script"),
...
''')
    ...
    test_cases = [
        ("analysis_scripts/test_scripts/test_hallucination.py", "Existing test script", True),
