...
""",
    ...
    @pytest.mark.asyncio
    async def test_qdrant_document_operations(self, ensure_qdrant_running, sample_documents):
    ...
    @pytest.mark.asyncio
    async def test_qdrant_code_operations(self, ensure_qdrant_running, sample_code_examples):
    ...
    @pytest.mark.asyncio
    async def test_qdrant_metadata_filtering(self, ensure_qdrant_running, sample_documents):
