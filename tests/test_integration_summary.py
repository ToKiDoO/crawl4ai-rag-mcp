...
def parse_url_input(url: Union[str, List[str]]) -> tuple[bool, Union[List[str], str]]:
    ...
    try:
        ...
        if isinstance(url, str):
            ...
            return False, f"URL must be a string or list of strings, got {type(url).__name__}"
...
def main():
    ...
    test_scenarios = [
        ...
        ("Wrong type", 12345),
        ("JSON with empty strings", '[\"https://example.com\", \"\", \"https://httpbin.org/html\"]'),
    ...
    print("  3. JSON array string: '[\"https://example.com\", \"https://httpbin.org/html\"]'")
