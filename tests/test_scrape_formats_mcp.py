...
async def test_scrape_formats():
    ...
    print("🧪 Testing scrape_urls function with multiple input formats via MCP tools...")
    print("=" * 60)
    ...
    for i, test_case in enumerate(test_cases):
        ...
        try:
            # Test using MCP tool
            from mcp__crawl4ai_docker__scrape_urls import mcp__crawl4ai_docker__scrape_urls
    ...
    try:
        ...
        print(f"   ❌ Search test exception: {str(e)}")
