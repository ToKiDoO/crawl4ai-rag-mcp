...
class CodeExampleFactory:
    ...
    def create(
        ...
        return {
            "language": lang,
            "code": code
            or random.choice(cls.SAMPLE_CODE.get(lang, ["print('Hello')"])),
...
class QueryFactory:
    ...
    @classmethod
    def create(cls, query: str | None = None) -> dict[str, Any]:
        """Create a test query."""
        return {
...
class TestDataSets:
    ...
    def ml_tutorial_set() -> list[TestDocument]:
        ...
        topics = [
            ...
            (
                "Linear Regression",
                "Understanding linear regression for predictive modeling",
            ),
