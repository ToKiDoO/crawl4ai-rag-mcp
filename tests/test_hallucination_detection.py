...
from utils.validation import validate_script_path, get_accessible_script_path
...
def test_path_mapping():
    ...
    test_cases = [
        ("analysis_scripts/test_scripts/test_hallucination.py", "/app/analysis_scripts/test_scripts/test_hallucination.py"),
        ("./analysis_scripts/user_scripts/my_script.py", "/app/analysis_scripts/user_scripts/my_script.py"),
        ("/tmp/test.py", "/app/tmp_scripts/test.py"),
        ("my_script.py", "/app/analysis_scripts/user_scripts/my_script.py"),
        ("test_scripts/test.py", "/app/analysis_scripts/user_scripts/test_scripts/test.py"),
    ]
