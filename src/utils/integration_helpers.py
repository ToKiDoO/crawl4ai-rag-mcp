...
class BatchProcessor:
    ...
    async def _process_with_semaphore(self, processor_func: Callable, item: Any, *args, **kwargs):
...
class IntegrationHealthMonitor:
    ...
    async def check_qdrant_health(self, qdrant_client) -> Dict[str, Any]:
        ...
        try:
            ...
            if collections is not None:
                return {
                    "status": "healthy", 
                    "collections_count": len(collections) if hasattr(collections, '__len__') else 0
                }
            else:
    ...
    async def get_integration_health(
        ...
        if qdrant_ok and neo4j_ok:
            ...
            elif qdrant_health["status"] == "healthy" or neo4j_health["status"] == "healthy":
...
async def validate_integration_health(database_client=None, neo4j_driver=None) -> Dict[str, Any]:
    """
