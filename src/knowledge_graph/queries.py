...
async def query_knowledge_graph(command: str) -> str:
    ...
    try:
        ...
        async with driver.session() as session:
            ...
            elif command_lower.startswith("query ") and len(parts) >= 2:
